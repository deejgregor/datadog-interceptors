...
class SetErrorInterceptor extends AbstractTraceInterceptor {
    ...
    public SetErrorInterceptor(int priority) {
        super(priority);

        String mappingList = getConfig("dd.error.set.mapping");
        if (mappingList != null) {
